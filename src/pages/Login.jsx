...
export default function Login() {
  ...
  return (
    <div className="auth-bg" style={{ display: 'flex', flexDirection: 'column' }}>
      <Navbar />
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%', paddingTop: '80px' }}>
